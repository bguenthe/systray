...
from PyQt5.QtWidgets import QDialog, QApplication, QSystemTrayIcon, QMessageBox, QComboBox, QLabel, QGroupBox, \
    QHBoxLayout, QCheckBox, QStyle, QLineEdit, QTextEdit, QPushButton, QAction, QMenu, QSpinBox, QGridLayout, qApp, \
    QVBoxLayout
